...
public class GridWriter {
	...
	public GridItem get(int index) throws IndexOutOfBoundsException {
		// Error checking, IndexOutOfBoundsException
	      if (index >= size) {
	         throw new IndexOutOfBoundsException("Index is out of bounds." + " Size of object is " + size);
	      }
		return items[index];
	}
	
	// Test that the new methods get() and size() work
...
//	}
	...
	// Test that the following code causes the GridWriter to throw an IndexOutOfBoundsException.
	public static void main(String[] args) {
		GridWriter gw = new GridWriter(40, 50);
